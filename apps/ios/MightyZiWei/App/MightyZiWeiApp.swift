...
struct MightyZiWeiApp: App {
  ...
  init() {
    ...
    if isUITesting {
      let startsWithICloudEnabled =
        arguments.contains("-UITestICloudEnabled")
    ...
    let connectionTester: any AIConnectionTesting =
      isUITesting
    ...
    let iCloudService: any ICloudSynchronizing =
      isUITesting
